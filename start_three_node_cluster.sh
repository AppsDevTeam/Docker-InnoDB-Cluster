...
$docker_run $params -e BOOTSTRAP=1 -e LOCAL_ADDRESS=mysqlgr1 -e GROUP_SEEDS="mysqlgr1:6606,mysqlgr2:6606,mysqlgr3:6606" -itd $INNODB_CLUSTER_IMG
...
$docker_run $params -e $GROUP_PARAM -e LOCAL_ADDRESS=mysqlgr2 -e GROUP_SEEDS="mysqlgr1:6606,mysqlgr2:6606,mysqlgr3:6606" -itd $INNODB_CLUSTER_IMG
...
$docker_run $params -e $GROUP_PARAM -e LOCAL_ADDRESS=mysqlgr3 -e GROUP_SEEDS="mysqlgr1:6606,mysqlgr2:6606,mysqlgr3:6606" -itd $INNODB_CLUSTER_IMG
